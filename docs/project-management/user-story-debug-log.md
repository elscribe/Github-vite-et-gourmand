...
| US-022 Comptes employes | Le mot de passe temporaire ne devait pas etre fixe ni affiche a l'admin. | Un mot de passe affiche en flash peut etre recopie ou conserve au mauvais endroit. | Generation d'un mot de passe unique en base, notification email sans mot de passe, activation/desactivation reservee admin. | "Seul l'admin cree le compte, mais l'employe choisit son mot de passe via la reinitialisation." |
