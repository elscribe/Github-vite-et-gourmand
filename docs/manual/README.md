...
| `user-manual.md` | Manuel utilisateur redige pour les parcours visiteur, client, employe et administrateur. |
| `user-manual.pdf` | Export PDF du manuel utilisateur, a regenerer si les captures finales changent. |
| `revision-sheets.md` | Fiches de revision pour expliquer le projet a l'oral. |

Le manuel utilisateur final presente les parcours reels, les identifiants de
demonstration et les captures des ecrans stabilises.
