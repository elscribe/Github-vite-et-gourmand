...
| US-004 | Visiteur | Detail menu | Detail menu desktop/mobile | `GET /menus/{id}` | Ouvrir un menu et verifier image principale synchronisee, galerie des plats, allergenes, conditions, stock et CTA commande. | Valide | P-FIGMA, P-ROUTE, P-RESULTAT, P-RESPONSIVE. Capture detail menu + galerie + composition + bouton commander ; la position 1 `menu_images` est l'image principale commune accueil/catalogue/detail. |
...
| US-019 | Admin | Administration menus | Gestion menus | `GET/POST /admin/menus` | Creer ou modifier un menu, associer des plats et gerer la galerie. | Valide admin, decision employe documentee | P-FIGMA, P-ROUTE, P-COMPTE, P-ACTION, P-RESULTAT, P-DONNEE, P-DB, P-DECISION. Capture formulaire menu + associations `menu_plats` + images `menu_images`; verifier que la position 1 pilote l'image principale accueil/catalogue/detail et que les suivantes alimentent la galerie. |
| US-020 | Admin | Administration plats | Gestion plats | `GET/POST /admin/plats` | Creer ou modifier un plat, type et allergenes associes. | Valide admin, decision employe documentee | P-FIGMA, P-ROUTE, P-COMPTE, P-ACTION, P-RESULTAT, P-DONNEE, P-DB, P-DECISION. Capture formulaire plat + associations allergenes; employe hors gestion offre volontaire. |
| US-021 | Admin | Administration horaires | Gestion horaires | `GET/POST /admin/horaires` | Modifier les horaires et verifier leur disponibilite dans l'interface publique. | Valide admin, decision employe documentee | P-FIGMA, P-ROUTE, P-COMPTE, P-ACTION, P-RESULTAT, P-DONNEE, P-DECISION. Capture admin horaires + footer public mis a jour dynamiquement. |
...
| Gestion avancee des images depuis l'admin | Validee pour le perimetre ECF : ajout et remplacement par fichier local PNG/JPG/WebP. | Tester ajout, remplacement, position, texte alternatif et affichage public synchronise. |
| Gestion menus/plats/horaires par employe | Separation volontaire des responsabilites entre operationnel et offre commerciale. | Justification dans `docs/project-management/decision-role-employe-menus-2026-07-22.md`; ajouter routes staff si conformite litterale exigee. |
