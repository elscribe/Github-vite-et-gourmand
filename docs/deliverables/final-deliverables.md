...
| Lien | Statut | Valeur |
|---|---|---|
| Depot GitHub public | A verifier avant rendu | <https://github.com/elscribe/Github-vite-et-gourmand> |
| Outil de gestion de projet Notion | A partager puis tester | A renseigner apres partage jury |
| Application deployee | A faire apres deploiement | A renseigner apres deploiement |
...
Ces comptes doivent etre testes sur l'application deployee avant de les copier
dans le document Studi.

## Documents locaux

| Livrable | Emplacement | Statut |
|---|---|---|
| README projet | `README.md` | A synchroniser apres deploiement. |
...
| Controle | Statut |
|---|---|
| GitHub public teste sans connexion. | A faire. |
| URL deployee testee sans connexion. | A faire. |
| Notion partage au jury et teste. | A faire. |
| Figma accessible au jury. | A faire. |
| Compte admin teste sur URL deployee. | A faire. |
| README contient les liens finaux. | A faire apres deploiement. |
| Documentation deploiement contient l'URL reelle. | A faire apres deploiement. |
| Manuel PDF contient les captures finales. | A faire apres deploiement si captures necessaires. |
| Copie Studi completee avec liens et identifiants. | A faire en dernier. |
