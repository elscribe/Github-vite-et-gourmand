    ...
    <div class="container">
        ...
        <div class="stats-grid admin-daily-stats">
            <div class="stat-card">
                ...
                <strong><?= (int) $adminStats['orders_to_process'] ?></strong>
            </div>
            <div class="stat-card">
                <span>CA pr&eacute;vu aujourd'hui</span>
                <strong><?= number_format((float) $adminStats['revenue_today'], 2, ',', ' ') ?> EUR</strong>
            </div>
            <div class="stat-card">
                <span>Pr&eacute;pa / livraison</span>
                <strong><?= (int) $adminStats['kitchen_delivery_followups'] ?></strong>
            </div>
            <div class="stat-card">
                <span>Avis &agrave; valider</span>
                <strong><?= (int) $adminStats['pending_reviews'] ?></strong>
            </div>
        </div>
