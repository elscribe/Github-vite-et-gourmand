...
$maxOrders = max(1, ...array_map(static fn (array $row): int => (int) $row['orders'], $dashboard['menuStats']));
...
<section class="page-section">
    <div class="container">
        ...
        <div class="section-heading">
            ...
            <p class="muted-text">Source des statistiques : <?= $this->e($dashboard['source']) ?></p>
        </div>
        ...
        <section class="table-wrapper backoffice-table-card">
            ...
            <table class="data-table">
                <caption class="visually-hidden">Performance des menus par commandes, chiffre d'affaires, panier moyen et note moyenne</caption>
                <thead>
                    <tr>
                        <th>Menu</th>
                        <th>Commandes</th>
